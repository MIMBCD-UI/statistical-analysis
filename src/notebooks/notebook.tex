...
{\color{incolor}In [{\color{incolor}1}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
        ...
        \PY{k+kn}{from} \PY{n+nn}{techniques} \PY{k}{import} \PY{n}{measures}
        \PY{k+kn}{from} \PY{n+nn}{methods} \PY{k}{import} \PY{n}{variance}
        \PY{k+kn}{from} \PY{n+nn}{methods} \PY{k}{import} \PY{n}{normalValidation}
        \PY{k+kn}{from} \PY{n+nn}{methods} \PY{k}{import} \PY{n}{anova}
\end{Verbatim}
